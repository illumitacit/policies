...
8. Verbal, physical, written or other abuse (including threats of abuse or retribution) of Company employee or officer
...
6. Under the California Consumer Privacy Act (“CCPA”), IllumiTacit is a “service provider”, not a “business” or “third
   ...
   for any other commercial purposes unless we have your explicit permission. And on the flip-side, you agree to comply
...
## Copyright and Content Ownership
 ...
 3. We do not pre-screen content, but reserve the right (but not the obligation) in our sole discretion to refuse or
...
10. On the flip-side, if you believe your material has been removed in error, you can file a written
...
2. Third parties may not access and employ the API if the functionality is part of an application that remotely records,
   ...
   applications. We, in our sole discretion, will determine if an integration service violates this bylaw. A third party
...
3. Abuse or excessively frequent requests to the Services via the API may result in the temporary or permanent
   suspension of your account’s access to the API. We, in its sole discretion, will determine abuse or excessive usage
