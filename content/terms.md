...
3. There is only one paid plan. The paid plan has limitations on the number of words that can be generated by our
   engine, as described in [the pricing table](https://illumitacit.com/#pricing). You will not be able to exceed the
   number of words associated with your chosen plan unless you upgrade your plan to add more capacity to your account.
   Words are counted as contiguous non-whitespace characters in the text. For languages that are not space-delimited,
   such as Chinese and Japanese, words are counted as non-whitespace, non-punctuation characters in the text.
...
4. Every generated text from a request to generate content (including, but not limited to, executing Macros, sending a
   ...
   references) will be counted towards usage on the account. Usage is counted in terms of the number of words generated
   by the request. This includes those originating from any request that is canceled mid process, either by using the
   cancel button in the UI or by closing the browser. Our underlying providers do not support canceling a request
   midway, and as such we account for words generated by the provider against the monthly limit on your account even
   though you may have canceled the request in IllumiTacit.

5. Certain AI models may have a [Minimum Word Consumption](https://illumitacit.com/#what-is-minimum-word-consumption)
   set. The Minimum Word Consumption is the minimum number of words that will be charged to your account for every
   request that uses the corresponding model. Your account will be charged the minimum if the generated word count for
   your request is less than the minimum. Refer to the [FAQ](https://illumitacit.com/#minimum-word-consumption-chart)
   for the current chart of Minimum Word Consumptions.

6. You can purchase additional word capacity in your plan at any time within your account settings. Additional capacity
   can only be purchased with the same billing cycle as your base subscription. You can not purchase words on a monthly
   billing cycle if you are on an annual plan, and you can not purchase words on an annual billing cycle if you are on a
   monthly plan. When adding more words into your plan, you are charged a pro rated amount between the purchase date and
   your next billing cycle, after which you will be charged the full monthly rate. For example, if you are on an annual
   plan that is billed on January 1st of every year and you decide to purchase more word capacity on April 1st, you will
   pay for those words for the rest of the year at a pro rated amount (3/4 the full amount), and then will be billed
   annually every January 1st for the full cost.

7. You can lower the available word capacity in your plan at any time within your account settings. You will
   keep the current word capacity until the end of the billing cycle, at which point the new amount will be reflected.
   IllumiTacit does not issue refunds for changes in word capacity. Lowering the number of words that are available in
   your plan may cause loss of capacity in your account which may make your existing usage untenable. IllumiTacit does
